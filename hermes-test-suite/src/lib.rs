...
macro_rules! test_suite {
    () => {
        ...
        t!(hotword_detected_works:
                    ...
                    with HotwordDetectedMessage { model_id: "some model".into(), site_id: "some site".into(), model_type: Some(::hermes::HotwordModelType::Universal), model_version: Some("1.2.3".into()) };);
