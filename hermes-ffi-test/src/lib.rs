...
#[no_mangle]
pub extern "C" fn hermes_ffi_test_round_trip_injection_complete(
...
#[no_mangle]
pub extern "C" fn hermes_ffi_test_round_trip_injection_reset_request(
    input: *const hermes_ffi::CInjectionResetRequestMessage,
    output: *mut *const hermes_ffi::CInjectionResetRequestMessage,
) -> ffi_utils::SNIPS_RESULT {
    wrap!(round_trip(input, output))
}

#[no_mangle]
pub extern "C" fn hermes_ffi_test_round_trip_injection_reset_complete(
    input: *const hermes_ffi::CInjectionResetCompleteMessage,
    output: *mut *const hermes_ffi::CInjectionResetCompleteMessage,
) -> ffi_utils::SNIPS_RESULT {
    wrap!(round_trip(input, output))
}
